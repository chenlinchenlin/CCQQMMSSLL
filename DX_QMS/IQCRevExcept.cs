...
namespace DX_QMS
{
    public partial class IQCRevExcept : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public IQCRevExcept()
        {
            InitializeComponent();
            setRule();
            string path = System.Configuration.ConfigurationManager.AppSettings["ServerFilePathRev"].ToString();
            this.serverFilePath = @path;
        }

        public IQCRevExcept(string productcode)
        {
            InitializeComponent();
            setRule();
            string path = System.Configuration.ConfigurationManager.AppSettings["ServerFilePathRev"].ToString();
        ...
        private DataSet bindData(string productcode)
        {
            ...
            return Common.DbAccess.SelectBySql(ssql);
        }
        private void txtlotno_Leave(object sender, EventArgs e)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtsupplier.Text = "";
                txtsupplier.Focus();
                DataTable ddd = bindData(txtproductcode.Text).Tables[0];
                databind.DataSource = ddd;
                lblinfo2.Text = txtproductcode.Text + "总共有不良项目数:" + ddd.Rows.Count;
            ...
            if (dslotno != null && ds.Tables.Count > 0 && dslotno.Tables[0].Rows.Count > 0)
            {
                ...
                DataSet ds2 = Common.DbAccess.SelectByOracle(Orasql2);
                if (ds2 != null && ds2.Tables.Count > 0 && ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtsupplier.Text = "";
                    txtsupplier.Focus();
                    DataTable dsd = bindData(txtproductcode.Text).Tables[0];
                    databind.DataSource = dsd;
                    lblinfo2.Text = txtproductcode.Text + "总共有不良项目数:" + dsd.Rows.Count;
                    lblinfo2.ForeColor = Color.Blue;
                    txtlotno.Leave += txtlotno_Leave;
                    return;
                }
        ...
        private void IQCRevExcept_Load(object sender, EventArgs e)
        {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            sql += " insert into IQC_RevExcept(productcode,pname,supplier,Reason,operuser,operdate,remark) values('" + txtproductcode.Text + "','";
        ...
        private void databind_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //string reason = databind.CurrentRow.Cells["不良现象"].Value.ToString();
